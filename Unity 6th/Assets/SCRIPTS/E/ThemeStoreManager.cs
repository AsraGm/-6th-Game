...
namespace ShootingRange
{
    public class ThemeStoreManager : MonoBehaviour
    {
        ...
        void SaveStoreData()
        {
            ...
            PlayerPrefs.Save();
            Debug.Log($"Datos de tienda guardados. Temas desbloqueados: {unlockedThemeIDs.Count}");
        }
        ...
        void LoadStoreData()
        {
            ...
            Debug.Log($"Datos de tienda cargados. Temas desbloqueados: {unlockedThemeIDs.Count}");
        }
